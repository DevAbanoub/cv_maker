...
ActiveRecord::Schema.define(version: 20170320031430) do
  ...
  create_table "cat_forms", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
    t.string "icon"
    t.string "hint_title"
  ...
  create_table "cvs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["template_id", "created_at"], name: "index_cvs_on_template_id_and_created_at"
  ...
  create_table "forms", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "position"
    t.bigint "user_id"
    t.bigint "cat_form_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cat_form_id", "created_at"], name: "index_forms_on_cat_form_id_and_created_at"
    t.index ["cat_form_id"], name: "index_forms_on_cat_form_id"
  ...
  add_foreign_key "cvs", "templates"
  add_foreign_key "cvs", "users"
  add_foreign_key "forms", "cat_forms"
